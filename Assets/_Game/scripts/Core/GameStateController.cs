...
public class GameStateController : IInitializable, IDisposable
{
    ...
    private bool isSubscribedToVehicleOccupied;
    ...
    public void Initialize()
    {
        ...
        if (!isSubscribedToVehicleOccupied)
        {
            signalBus.Subscribe<VehicleOccupiedSignal>(OnVehicleOccupied);
            isSubscribedToVehicleOccupied = true;
        }
    }
    ...
    public void Dispose()
    {
        ...
        signalBus.TryUnsubscribe<VehicleOccupiedSignal>(OnVehicleOccupied);
        isSubscribedToVehicleOccupied = false;
    }
